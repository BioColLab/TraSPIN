...
from .protein_pool import dense_mincut_pool,MotifPool
## for cluster
...
class net(torch.nn.Module):
    def __init__(self, prot_deg,
        ...
        self.atom_embed= torch.nn.Linear(767, hidden_channels)#1024
    ...
    def forward(self, mol_x, mol_x_feat, total_fea, bond_x, atom_edge_index,
        ...
        for idx in range(self.total_layer):
            ...
            residue_enz = global_add_pool(residue_x, prot_batch) #(32,200)
        ...
        mol_prot_feat = torch.cat([enz_feas1, clu_fea,mol_x], dim=-1)  #enz_feas2,
        ...
        return binary_pred, spectral_loss, ortho_loss, cluster_loss, attention_dict
